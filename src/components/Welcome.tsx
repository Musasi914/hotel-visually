...
const WELCOME_TITLE = "What you see is what you get.";
const WELCOME_TEXT =
  ...
  return (
    <section className="js-welcome">
      <div className="grid min-h-screen grid-cols-2 gap-x-20 content-center p-8">
        ...
        <h2 className="js-welcome-title col-span-full text-[12vw] leading-[1.2] mb-10">{WELCOME_TITLE}</h2>
